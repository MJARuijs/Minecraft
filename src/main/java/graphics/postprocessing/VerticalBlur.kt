...
class VerticalBlur(private val strength: Float) {

    private val shaderProgram = ShaderProgram.load("shaders/postprocessing/gaussian_vertical_blur.vert", "shaders/postprocessing/gaussian_blur.frag")
